    ...
    if ($result->num_rows > 0) {
        ...
        <form id="update-form" action="" method="POST">
            ...
            <select name="hotel" required>
                <option value="hotel1" <?php if ($row['hotel'] == 'hotel1') echo 'selected'; ?>>Hotel 1</option>
                <option value="hotel2" <?php if ($row['hotel'] == 'hotel2') echo 'selected'; ?>>Hotel 2</option>
                <option value="hotel3" <?php if ($row['hotel'] == 'hotel3') echo 'selected'; ?>>Hotel 3</option>
            </select>
